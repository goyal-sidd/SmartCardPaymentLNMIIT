...
class GUI(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        container = ttk.Frame(self, width=1000, height=667)
...
class StartPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        label1 = ttk.Label(self, text="Cashless System", font=font_title)
        ...
        self.entry1 = ttk.Entry(self, textvariable=tercon)
...
class vKeyboard(ttk.Frame):
    ...
    def _attach_key_press(self, k):
        if k == '>>>':
            ...
            tercon1 =  tercon.get() 
            print tercon1                                   # Define, what's supposed to happen..
